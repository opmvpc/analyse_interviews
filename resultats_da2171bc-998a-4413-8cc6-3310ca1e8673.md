...
| --- | --- | --- | --- |
| autonomie | 3730 | 622 | 0.17 |
| gain_de_temps | 3730 | 553 | 0.15 |
| augmentation_productivite | 3730 | 232 | 0.06 |
| propriete_du_contenu | 3730 | 212 | 0.06 |
| biais_culturels | 3730 | 181 | 0.05 |
| engagement_des_etudiants | 3730 | 163 | 0.04 |
| amelioration_des_pratiques_d_enseignement | 3730 | 149 | 0.04 |
| innovation | 3730 | 98 | 0.03 |
| nouvelles_methodes_d_enseignement | 3730 | 59 | 0.02 |
| correction_des_biais | 3730 | 53 | 0.01 |
...
- **3**: Et là-dessus oui ça améliore la qualité de mon travail. Donc usage très précis. (Phrase à vérifier).

## Intervenant: Adrien - Code: autonomie

- **12**: J’utilise GPT. Alors moi je vais te dire j’ai un usage très spécifique dans ce cas-là c’est plus comme je dois donner le cours en anglais tout écrire en anglais je le fais repasser sur mes phrases plutôt quoi. Oui c’est mon contenu vraiment oui.
- **10**: Si tu as un doute sur une référence oui il faut faire des recherches à côté et les corriger ça c’est sûr. Je ne fais pas confiance je fais 0% confiance à chatGPT pour mon contenu final en tout cas. Vu que c’est moi qui le crée ben 5.
- **9**: C’est plus dans une visée un peu réflexive tu vois : « Donne-moi des idées sur telle chose ou est-ce qu’on peut mieux formuler cette phrase » ? Tu vois ce genre de choses quoi. On parle de chatGPT ?
- **9**: C’était essayer de fournir des sous-chapitres et des sous-titres. Moi c’est plus moi qui faisais le contenu au final. En fait chatGPT c’est du contenu très généraliste.
- **8**: C’est un danger parce que c’est une tentation en fait d’aller directement à des réponses sans passer par la démarche qu’on souhaite faire, faire à l’élève. Il y a une démarche qui peut être déstabilisante qui est de ne pas savoir temporairement, de prendre un risque. De tu vois toutes les étapes qui passent par faire du brouillon, faire des recherches, améliorer son brouillon, organiser sa pensée.
...
- **12**: Et après il suggère et c’est pas toujours bien ce qu’il suggère non plus. Donc on sait qu’il y a des mots que chatGPT va surutiliser comme Delve to Delve. Si je le vois je ne vais pas le mettre par exemple quoi.
...
- **12**: Je pense essentiellement à des biais de genre dans la langue mais bon ça c’est classique ou des choses inexactes c’est ça que tu disais ? Non mais je ne suis pas allé très loin. Donc mais je n’ai pas remarqué non.
...
- **6**: Et après il suggère et c’est pas toujours bien ce qu’il suggère non plus. Donc on sait qu’il y a des mots que chatGPT va surutiliser comme Delve to Delve. Si je le vois je ne vais pas le mettre par exemple quoi.
...
- **10**: IL y a des fonctionnalités d’export actuellement ? Là si je me projette ça, ça peut être bien dans le sens où tu as édité ton truc et après ben pour correspondre au format exigé par les écoles il faut sortir un PDF par exemple tu vois. La question c’est avez-vous ou auriez-vous ?
- **6**: J’utilise GPT. Alors moi je vais te dire j’ai un usage très spécifique dans ce cas-là c’est plus comme je dois donner le cours en anglais tout écrire en anglais je le fais repasser sur mes phrases plutôt quoi. Oui c’est mon contenu vraiment oui.
- **5**: Mais je ne suis pas allé suffisamment loin. Maintenant voilà je pense que ça pourrait être un produit intéressant. Est-ce que je l’utiliserais dans le sens où est-ce qu’il me sauve la vie plus que pour l’instant tout faire avec Google Docs ?

## Intervenant: Adrien - Code: innovation

- **3**: Mais ça va beaucoup passer par attendre que les modèles évoluent aussi quoi je pense. Oui stimuler la créativité oui. C’est l’autre aspect c’est je n’ai pas pensé un truc il peut être suggéré quoi.
...
- **8**: C’était essayer de fournir des sous-chapitres et des sous-titres. Moi c’est plus moi qui faisais le contenu au final. En fait chatGPT c’est du contenu très généraliste.
- **3**: Donc je en sais pas tu vois ce que ça signifie après en termes de propriété intellectuelle. Moi dans le sens général j’aimerais peut-être rassuré sur le fait que c’est un peu le même fonctionnement qu’un Google Docs tu vois juste un éditeur quoi. Des biais non je pense qu’il y en a sûrement.
